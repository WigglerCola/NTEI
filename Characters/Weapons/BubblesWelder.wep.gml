...
global.sprWeaponArt       = sprite_add_weapon("../../sprites/weapons/loadout/sprBubblesWelderLoadout.png",24,18,);
...
#define weapon_text             return "@(color:16745694)WAS THERE A MISSION?";
#define nts_weapon_examine      return{ "d": "A STANDARD WELDING TOOL, PUT IT TO GOOD USE. ",}
...
//Laser Brain
if skill_get(17){
sound_play_pitchvol(sndEnergyScrewdriverUpg,random_range(0.9,1.2),0.6);
sound_play_pitchvol(sndEnergySword,random_range(1.1,1.3),0.55);
} else {
//Default
sound_play_pitchvol(sndEnergyScrewdriver,random_range(0.9,1.2),0.6);
sound_play_pitchvol(sndEnergySword,random_range(1.1,1.3),0.55);
}
