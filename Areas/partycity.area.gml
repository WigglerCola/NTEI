...
global.sprFogParty = sprite_add("../sprites/areas/partycity/sprFogParty.png",36,0,0);
...
#macro DEBUG true// remember to set to false before sharing
    ...
    if DEBUG{
        trace("Press 5 to access party area");
        if fork(){
...
#define area_setup
    ...
    TopCont.fog      = global.sprFogParty;
    safespawn = 1;
...
if (random(25) < 1) mod_script_call('mod', 'devzone', 'Devbox_create', x + 16, y + 16);
if (random(40) < 1) mod_script_call('mod', 'devzone', 'Devcone_create', x + 16, y + 16);
if (random(60) < 1) mod_script_call('mod', 'devzone', 'Devlight_create', x + 16, y + 6);
...
#define ConfettiSprayer_create(_x, _y)
