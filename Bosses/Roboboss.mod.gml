...
//firecounters
if alrm1 > 0 
	alrm1 -= (current_time_scale + (GameCont.loops * current_time_scale))
if alrm2 > 0 
	alrm2 -= (current_time_scale + (GameCont.loops * current_time_scale))
if alrm3 > 0 
	alrm3 -= (current_time_scale + (GameCont.loops * current_time_scale))
//firecounter
if laserfiring > 0 
	laserfiring -= current_time_scale
...
if distance_to_object(target) > 70 and (random(20) < current_time_scale) and active = 1{
